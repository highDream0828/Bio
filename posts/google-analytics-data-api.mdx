...
In my [portfolio](https://portfolio-alex.web.app/), I have just implemented [Google Analytics Data API](https://developers.google.com/analytics/devguides/reporting/data/v1) so that I can show how many people have visited this site in the last 7 days. As my Portfolio is already using Google Analytics to track user visits. I just need to use its API to fetch that data.

But first, look at how it's showing in [my portfolio](https://portfolio-alex.web.app/):
...
This is all you need to fetch the data. and It will return the response. My portfolio code can be found on [GitHub](https://github.com/scarlett1130/Bio/blob/main/pages/api/ga.ts) you can check out How I used it.
