...
```
To see my stats you can visit `https://alex.vercel.app/api/stats/tracks`.
...
Now, as you can see on my [website's](http://alex.vercel.app/) footer there is an option to see if I am currently playing the song or not, if yes then which one. To do that, we fetch the following URL.
...
You can view the Example of this on my [website](http://alex.vercel.app/stats)
